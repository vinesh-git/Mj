			...
			<div className="container-contact100">
				<div className="wrap-contact100">
					<form name="dform" className="contact100-form validate-form"  onSubmit={handleSubmit}>
						...
						<input type="file" id="helocsv" name="csvexcelfile" align="center"   onChange={e => {loadFileAsTextCsv(e);uploadSingleFile()  }} />
						...
						<div className="upload">
							<button type='button' className='btn-warning'  >
								...
								<input type="file" id="helo" name="jsonfile" align="center"   onChange={e => { loadFileAsText(e);  }} required/>
